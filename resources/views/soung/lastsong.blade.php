...
@section('lastsong')
    ...
    <main class="grid place-items-center min-h-screen background-radial-gradient p-5">
        ...
        <div>
            <h1 class="text-4xl sm:text-5xl md:text-7xl font-bold text-gray-200 mb-5">Latest songs</h1>
            <section class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                @foreach ($songs as $song)
                    <div class="bg-gray-900 shadow-lg rounded p-3">
                        <div class="group relative">
                            <img class="w-full md:w-72 block rounded" src="/storage/covers/{{ $song->cover }}"
                                alt="" />
                            <div
